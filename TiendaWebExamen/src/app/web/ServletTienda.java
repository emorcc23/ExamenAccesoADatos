...
public class ServletTienda extends HttpServlet {
	...
	ItfzProductosDAO negocio = new NegocioProductos();
	...
	private String peticionTodos(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	private String peticionBuscar(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	private String peticionComprar(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	private String peticionSacar(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	private String peticionLogin(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
